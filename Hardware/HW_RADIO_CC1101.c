...
#define CC1101_SPIx_CLOCK 	RCC_APB1Periph_SPI2	//CC1101所使用硬件SPI时钟
#define CC1101_SPIx 	  	SPI2  				//CC1101所使用的硬件SPI号

#define CC1101_SCK_CLOCK	RCC_APB2Periph_GPIOB	//SPI时钟引脚PB13
#define CC1101_SCK_PORT		GPIOB
#define CC1101_SCK_PIN		GPIO_Pin_13

#define CC1101_MISO_CLOCK	RCC_APB2Periph_GPIOB	//SPI的MISO引脚PB14
#define CC1101_MISO_PORT	GPIOB
#define CC1101_MISO_PIN		GPIO_Pin_14

#define CC1101_MOSI_CLOCK	RCC_APB2Periph_GPIOB	//SPI的MOSI引脚PB15
#define CC1101_MOSI_PORT	GPIOB
#define CC1101_MOSI_PIN		GPIO_Pin_15

#define CC1101_CS_CLOCK 	RCC_APB2Periph_GPIOB	//SPI的片选引脚PB12
...
#define CC1101_IRQ_CLOCK 	RCC_APB2Periph_GPIOB
#define CC1101_IRQ_PIN		GPIO_Pin_0
#define CC1101_IRQ_PORTSOURCE 	GPIO_PortSourceGPIOB	//外部中断端口源
